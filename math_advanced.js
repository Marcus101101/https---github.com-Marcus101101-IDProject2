$(document).ready(function () {
    ...
    function getContacts(limit = 100, all = true) {
      ...
      let settings = {
        "async": true,
        "crossDomain": true,
        "url": "https://idleaderboardfinal-5736.restdb.io/rest/math-advance",
    ...
    function updateForm(id, contactName, contactMsg) {
      ...
      var settings = {
        "async": true,
        "crossDomain": true,
        "url": `https://idleaderboardfinal-5736.restdb.io/rest/math-advance${id}`,//update based on the ID
        "method": "PUT",
        "headers": {
          "content-type": "application/json",
          "x-apikey": APIKEY,
